function(gba_compile_c source)
    ...
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL Windows)
        ...
        if(NOT CC)
            ...
            if(CC)
                execute_process(COMMAND "${CC}" "${path}/${FILE_NAME}" /link /out:"${path}/${FILE_NAME_WE}.exe")
            endif()
        endif()
        ...
        if(NOT CC)
            ...
            if(CC)
                execute_process(COMMAND "${CC}" -o "${path}/${FILE_NAME_WE}.exe" "${path}/${FILE_NAME}")
            endif()
        endif()
    ...
    elseif(CMAKE_HOST_SYSTEM_NAME STREQUAL Linux OR CMAKE_HOST_SYSTEM_NAME STREQUAL Darwin)
        ...
        if(NOT CC)
            ...
            if(CC)
                execute_process(COMMAND "${CC}" -o "${path}/${FILE_NAME_WE}" "${path}/${FILE_NAME}")
            endif()
        endif()
