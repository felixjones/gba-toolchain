...
set(CMAKE_ASM_LINK_EXECUTABLE "${GCCBin}g++ <CMAKE_ASM_LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")

set(CMAKE_C_LINK_FLAGS "-lc")
set(CMAKE_C_LINK_EXECUTABLE "${GCCBin}g++ <CMAKE_C_LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")

set(CMAKE_CXX_LINK_FLAGS "-lc -lstdc++")
set(CMAKE_CXX_LINK_EXECUTABLE "${GCCBin}g++ <CMAKE_CXX_LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
