...
function(_configure_toolchain)
    ...
    # Flags for Debug
    set(CMAKE_C_FLAGS_DEBUG_INIT "-O0 -g" CACHE STRING "${DOCSTRING_CMAKE_C_FLAGS_DEBUG}")
    set(CMAKE_CXX_FLAGS_DEBUG_INIT "-O0 -g" CACHE STRING "${DOCSTRING_CMAKE_CXX_FLAGS_DEBUG}")
