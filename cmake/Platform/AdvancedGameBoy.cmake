...
function(install_rom target)
    ...
    set(singleValueArgs CONCAT_ALIGN DESTINATION)
    ...
    if(NOT ARGS_CONCAT_ALIGN)
        set(ARGS_CONCAT_ALIGN 1)
    endif()
    ...
    install(CODE "
        ...
        if(appendFiles)
            ...
            binconcat(${ARGS_CONCAT_ALIGN} \"${INSTALL_DESTINATION}/$<TARGET_FILE_BASE_NAME:${target}>.gba\" \${appendFiles})
        endif()
    ")
endfunction()
